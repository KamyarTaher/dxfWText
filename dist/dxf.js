...
var textRend = function textRend(entity) {
  ...
  console.log(entity);
  var bbox = new _vecks.Box2();
  var element = "<text x=\"".concat(entity.x, "\" y=\"").concat(-entity.y, "\" rotate=\"", 180, "\"  font-size=\"").concat(entity.textHeight, "px\" transform=\"matrix(1,0,0,-1,0,0)\">").concat(entity.string, "</text>");
  return (0, _transformBoundingBoxAndElement["default"])(bbox, element, entity.transforms);
};
/**
